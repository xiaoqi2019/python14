...
class DoExcel:
    ...
    def read_excel(self,sheet_name):
        ...
        MyLog().info('开始读取数据了！')
        case_id=ReadConfig(project_path.conf_path,'CASE','case_id').get_str()
        tel_sheet=self.wb['tel']
        tel=tel_sheet.cell(2,1).value
