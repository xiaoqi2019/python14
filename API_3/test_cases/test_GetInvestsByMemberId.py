...
#测试充值接口
test_data=DoExcel(project_path.case_path,'GetInvestsByMemberId').read_excel('GetInvestsByMemberId')
...
class TestCases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.de=DoExcel(project_path.case_path,'GetInvestsByMemberId')
    def tearDown(self):
