...
class MyLog:
    ...
    def __init__(self):
        self.logger_name=ReadConfig(project_path.new_conf_path,'LOG','logger_name').get_str()
        self.stream_level=ReadConfig(project_path.new_conf_path,'LOG','stream_level').get_str()
        self.file_level=ReadConfig(project_path.new_conf_path,'LOG','file_level').get_str()
        self.formatter=ReadConfig(project_path.new_conf_path,'LOG','formatter').get_str()
    #配置日志收集器的名字
